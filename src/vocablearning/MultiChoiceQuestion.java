...
public class MultiChoiceQuestion extends Question {
    ...
    /**
     * This method generates three other possible words from the word list
     * and adds the the word which has the correct answer and then shuffles
     * the list to ensure that the order of the potential answers is random
     * @param wordList The word list which that is read in from file
     * @return 
     */
